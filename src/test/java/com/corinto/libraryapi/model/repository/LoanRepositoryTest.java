...
import static com.corinto.libraryapi.model.repository.BookRepositoryTest.createNewBook;
...
public class LoanRepositoryTest {
    ...
    public void findByBookIsbnOrCustomerTest(){
        ...
        Page<Loan> result = repository.findByBookIsbnOrCustomer(
                "123", "beavis", PageRequest.of(0, 10));
    ...
    public Loan createAndPersistLoan(LocalDate loanDate){
        ...
        Loan loan = Loan.builder().book(book).customer("beavis").loanDate(loanDate).build();
