...
import com.corinto.libraryapi.service.impl.BookServiceImpl;
...
public class BookServiceTest {
    ...
    public void saveBookTest() {
        ...
        assertThat(savedBook.getAuthor()).isEqualTo("beavis");
    }

    private Book createValidBook() {
        return Book.builder().isbn("123").author("beavis").title("As aventuras").build();
    }
