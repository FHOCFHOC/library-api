...
import com.corinto.libraryapi.service.LoanServiceTest;
...
public class LoanControllerTest {
    ...
    public void createLoanTest() throws Exception {
        ...
        LoanDTO dto = LoanDTO.builder().isbn("123").email("customer@email.com").customer("beavis").build();
        String json = new ObjectMapper().writeValueAsString(dto);

        Book book = Book.builder().id(1l).isbn("123").build();
        BDDMockito.given( bookService.getBookByIsbn("123") ).willReturn(Optional.of(book) );

        Loan loan = Loan.builder().id(1l).customer("beavis").book(book).loanDate(LocalDate.now()).build();
    ...
    public void invalidIsbnCreateLoanTest() throws  Exception{
        ...
        LoanDTO dto = LoanDTO.builder().isbn("123").customer("beavis").build();
        String json = new ObjectMapper().writeValueAsString(dto);
